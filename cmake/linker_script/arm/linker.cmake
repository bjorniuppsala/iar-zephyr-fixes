...
#. = ALIGN( 1 << LOG2CEIL(region_size))
  #Handling this requires us to handle log2ceil() in iar linker since the size isnt known until then. 
  set(MPU_ALIGN_BYTES ${region_min_align})
  #message(WARNING "We can not handle . = ALIGN( 1 << LOG2CEIL(region_size))  ")
else()
  set(MPU_ALIGN_BYTES ${region_min_align})
endif()
#The APP_SHARED_ALIGN and SMEM_PARTITION_ALIGN macros are defined as ". = ALIGN(...)" things. 
...
if(CONFIG_USERSPACE)
  #This is where the app_mem_partition stuff is going to be placed, once it is
  # generated by gen_app_partitions.py. _app_smem has its own init-copy handling 
  # in z_data_copy, so put it in RAM_REGIOM rather than DATA_REGION
