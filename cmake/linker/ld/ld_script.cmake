...
function(system_to_string)
  ...
  set(${STRING_STRING} "${${STRING_STRING}}.last_section :\n")
  set(${STRING_STRING} "${${STRING_STRING}}{\n")
  if(${CONFIG_LINKER_LAST_SECTION_ID})
    set(${STRING_STRING} "${${STRING_STRING}}   LONG(${CONFIG_LINKER_LAST_SECTION_ID_PATTERN})\n")
  endif()
  set(${STRING_STRING} "${${STRING_STRING}}} > FLASH\n")
  set(${STRING_STRING} "${${STRING_STRING}}_flash_used = LOADADDR(.last_section) + SIZEOF(.last_section) - __rom_region_start;\n")
