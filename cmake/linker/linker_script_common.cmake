...
function(do_var_replace_in res_ptr src)
  ...
  foreach(match IN LISTS match_res)
    ...
    #the variable expression is as follows: s
    ...
    elseif("${expr}" MATCHES ";undef:([^,]*)")
      ...
      set(value "${match}")
      # cant warn here because we cant check for what is relevant in this pass
      #message(WARNING "Missing defintion for ${match}")
    endif()
