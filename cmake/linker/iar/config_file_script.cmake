...
function(section_to_string)
  ...
  set(INIT_SECTIONS_BLOCK "define block ${name_clean}_init")
  set(TEMP "${TEMP}define block ${name_clean}")
  set(A "")
  list(APPEND A "with fixed order")
  if (align)
    list(APPEND A "alignment=${align}")
  else()
    list(APPEND A "alignment=4")
  endif()
  if (endalign)
    list(APPEND A "end alignment=${endalign}")
  endif()
  if(min_size)
    list(APPEND A "minimum size=${min_size}")
  endif()
  if(max_size)
    list(APPEND A "maximum size=${max_size}")
  endif()
  list(JOIN A ", " A)
