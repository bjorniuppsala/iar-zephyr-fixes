...
#define __noinit             _Pragma("object_attribute=__no_init") __in_section_unique(_NOINIT_SECTION_NAME)
#define __noinit_named(name)                                                                       \
	_Pragma("object_attribute=__no_init") __in_section_unique_named(_NOINIT_SECTION_NAME, name)
#else
